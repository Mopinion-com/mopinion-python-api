...
class Client:
    ...
    def api_request(self, endpoint="/account", method="GET", body="", query=""):
        ...
        uri_and_body_hmac_sha256 = hmac.new(self.signature_token.encode('utf-8'), msg=uri_and_body, digestmod=hashlib.sha256).hexdigest()
    
        xtoken = b64encode('{}:{}'.format(self.public_key, uri_and_body_hmac_sha256).encode('utf-8'))
